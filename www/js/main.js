...
u3.initCommon(ud, GAME_DIFFICULTY_NORMAL, UNIT_SYURUI_TATEO, BATTLE_MIKATA, BATTLE_OFFENCE, 1, 25, SKILL_HIGHAVO, SKILL_KYOEN, 0);
ud.push(u3);
var intervalId;
...
u4.initTeki(ud, GAME_DIFFICULTY_NORMAL, UNIT_SYURUI_POISON, BATTLE_TEKI, BATTLE_DEFENCE, 1, 20, 0, 0, 0, ITEM_TYPE_SWORD, 1, BATTLEAI_FM_FRONT + BATTLEAI_AT_BACK + BATTLEAI_SM_BACK);
ud.push(u4);
...
u5.initTeki(ud, GAME_DIFFICULTY_NORMAL, UNIT_SYURUI_STUN, BATTLE_TEKI, BATTLE_DEFENCE, 1, 20, 0, 0, 0, ITEM_TYPE_PUNCH, 1, BATTLEAI_FM_FRONT + BATTLEAI_AT_FIRST + BATTLEAI_SM_BACK);
ud.push(u5);
var u6 = new UnitDefine();
u6.initTeki(ud, GAME_DIFFICULTY_NORMAL, UNIT_SYURUI_KNIFE, BATTLE_TEKI, BATTLE_DEFENCE, 1, 20, 0, 0, 0, ITEM_TYPE_KNIFE, 1, BATTLEAI_FM_FRONT + BATTLEAI_AT_MAXDM + BATTLEAI_SM_BACK);
ud.push(u6);

...
u.initCommon(ud, GAME_DIFFICULTY_NORMAL, UNIT_SYURUI_KNIGHT, BATTLE_MIKATA, BATTLE_OFFENCE, 1, 20, 0, 0, 0);
ud.push(u);
var u2 = new UnitDefine();
u2.initCommon(ud, GAME_DIFFICULTY_NORMAL, UNIT_SYURUI_MUSCLE, BATTLE_MIKATA, BATTLE_OFFENCE, 1, 15, 0, 0, 0);
ud.push(u2);
var u3 = new UnitDefine();
u3.initCommon(ud, GAME_DIFFICULTY_NORMAL, UNIT_SYURUI_TATEO, BATTLE_MIKATA, BATTLE_OFFENCE, 1, 25, 0, 0, 0);
ud.push(u3);
var intervalId;

...
u2.initCommon(ud, GAME_DIFFICULTY_NORMAL, UNIT_SYURUI_MUSCLE, BATTLE_MIKATA, BATTLE_OFFENCE, 1, 20, 0, 0, 0, ITEM_TYPE_SPEAR, 1);
ud.push(u2);
var u3 = new UnitDefine();
u3.initCommon(ud, GAME_DIFFICULTY_NORMAL, UNIT_SYURUI_TATEO, BATTLE_MIKATA, BATTLE_OFFENCE, 1, 20, 0, 0, 0, ITEM_TYPE_BOW, 1);
ud.push(u3);
var intervalId;
intervalId = setInterval(calcAndPaint, 20);
var u4 = new UnitDefine();
u4.initCommon(ud, GAME_DIFFICULTY_NORMAL, UNIT_SYURUI_HAMMER, BATTLE_TEKI, BATTLE_DEFENCE, 1, 20, 0, 0, 0, ITEM_TYPE_HAMMER, 1);
ud.push(u4);
var u5 = new UnitDefine();
u5.initCommon(ud, GAME_DIFFICULTY_NORMAL, UNIT_SYURUI_PUNCH, BATTLE_TEKI, BATTLE_DEFENCE, 1, 20, 0, 0, 0, ITEM_TYPE_PUNCH, 1);
ud.push(u5);
var u6 = new UnitDefine();
u6.initCommon(ud, GAME_DIFFICULTY_NORMAL, UNIT_SYURUI_KNIFE, BATTLE_TEKI, BATTLE_DEFENCE, 1, 20, 0, 0, 0, ITEM_TYPE_KNIFE, 1);
ud.push(u6);
...
itemMap.set(tempItem.namae, {equipNum: 1, allNum:1});
ItemDefine.init(ITEM_TYPE_SWORD, 1, tempItem);
itemMap.set(tempItem.namae, {equipNum: 2, allNum:3});

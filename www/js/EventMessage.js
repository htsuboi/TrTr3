...
EventMessage.getMessage = function(eventNum, message) {
    switch(eventNum) {
        ...
        /*case EVENTVIEW_EVENTID_OP_WIN:arguments
            ...
            message.push("明日の朝、王室管理課に直接連絡しましょう。");
            message.push("それまで、あなたはどうしますか?");
            message.push("私の部屋に、きますか?」");
            message.push("#" + UNIT_SYURUI_KNIGHT);
            message.push("@" + EVENTVIEW_EVENTFONT_KAIWA);
            message.push("【" + UNIT_NAMAE_KNIGHT + "】");
            message.push("「えっ、そっ、そんな!");
            message.push("何を、なにを言っているのですか!?");
            message.push("これまで女性の部屋に入ったことなどありません!");
            message.push("それがこんな夜中に、あなたの部屋にですと!");
            message.push("ありえません、絶対にありえません!」");
            message.push("今からでも、宿はいくらでも見つかります。」");
            message.push("#" + UNIT_SYURUI_PRINCESS);
            message.push("@" + EVENTVIEW_EVENTFONT_KAIWA);
            message.push("【" + UNIT_NAMAE_PRINCESS + "】");
            message.push("「…もし、明日の朝までに");
            message.push("彼らの仲間がまた襲ってきたら…。」");
            message.push("#" + UNIT_SYURUI_NOFACE);
            message.push("@" + EVENTVIEW_EVENTFONT_NORMAL);
            message.push("二人の若者は、眠れぬ夜を過ごした。");
            break;*/
    }
}